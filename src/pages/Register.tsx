...
import { Heart, Stethoscope, User, ArrowRight, Store } from "lucide-react";
...
const Register = () => {
    ...
    const [role, setRole] = useState<"doctor" | "patient" | "chemist">("patient");
                    ...
                    <form onSubmit={handleRegister} className="space-y-4">
                        ...
                        <div className="space-y-3 pt-2">
                            ...
                            >
                                ...
                                <div>
                                    <RadioGroupItem value="chemist" id="chemist" className="peer sr-only" />
                                    <Label
                                        htmlFor="chemist"
                                        className="flex flex-col items-center justify-between rounded-xl border-2 border-muted bg-popover p-4 hover:bg-accent hover:text-accent-foreground peer-data-[state=checked]:border-primary [&:has([data-state=checked])]:border-primary cursor-pointer transition-all text-center"
                                    >
                                        <Store className="mb-2 h-6 w-6" />
                                        <span className="font-semibold text-sm">Chemist</span>
                                    </Label>
                                </div>
                            </RadioGroup>
                        </div>
