...
const navItems = [
  ...
  { id: "ar-guide", label: "AR First Aid Guide", icon: ScanFace },
  { id: "first-aid", label: "First Aid & Remedies", icon: HeartPulse },
  { id: "book", label: "Book Appointment", icon: CalendarPlus },
  { id: "appointments", label: "My Appointments", icon: CalendarCheck },
  { id: "prescriptions", label: "Prescription", icon: FileText },
  { id: "medicines", label: "Get Medicines", icon: Pill },
...
export default function PatientSidebar({ activeSection, setActiveSection }: PatientSidebarProps) {
  ...
  return (
    <aside className="w-64 min-h-screen bg-slate-900 flex flex-col">
      {/* Logo */}
      <div className="px-6 py-6 border-b border-slate-700 flex justify-center">
        <img src={logoImg} alt="Patient Portal Logo" className="h-12 w-auto" />
      </div>
