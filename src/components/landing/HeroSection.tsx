...
const HeroSection = () => {
  ...
  return (
    <section id="home" className="relative min-h-[90vh] flex items-center gradient-hero overflow-hidden pt-20">
      <Particles particleColors={['#10b981', '#059669', '#047857', '#065f46']} className="" />
      {/* Decorative blobs */}
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 animate-fade-up" style={{ animationDelay: "0.3s" }}>
              <Button
                size={"lg" as any}
                className="gradient-vitality text-primary-foreground font-semibold rounded-xl px-8 h-14 text-base glow"
                onClick={handleStart}
              >
                {user ? "Go to Dashboard" : "Consult Now"}
                <ArrowRight className="w-5 h-5 ml-2" />
              </Button>
              <Button size={"lg" as any} variant={"outline" as any} className="rounded-xl px-8 h-14 text-base border-border hover:bg-muted font-medium">
