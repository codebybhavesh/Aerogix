...
interface AuthContextType {
    user: User | null;
    role: "doctor" | "patient" | "chemist" | null;
    loading: boolean;
}
...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    const [role, setRole] = useState<"doctor" | "patient" | "chemist" | null>(null);
                ...
                unsubscribeDoc = onSnapshot(doc(db, "users", user.uid),
                    (userDoc: DocumentSnapshot) => {
                        ...
                        if (userDoc.exists()) {
                            ...
                            if (rawRole === "doctor" || rawRole === "patient" || rawRole === "chemist") {
                                console.log("Role updated from snapshot:", rawRole);
                                setRole(rawRole as "doctor" | "patient" | "chemist");
                            } else {
