...
export default function PatientSidebar({ activeSection, setActiveSection }) {
  return (
    <aside className="w-64 min-h-screen bg-slate-900 flex flex-col">
      ...
      <div className="px-3 pb-6">
        <button className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium text-slate-400 hover:bg-red-500/10 hover:text-red-400 transition-all duration-150">
          <LogOut size={18} />
          Logout
        </button>
      </div>
