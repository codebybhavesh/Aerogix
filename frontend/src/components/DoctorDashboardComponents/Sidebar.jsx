  ...
  return (
    <aside className="w-64 min-h-screen bg-[#0f1f3d] flex flex-col shadow-2xl">
      ...
      <div className="px-3 py-4 border-t border-blue-900/50">
        <button className="w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium text-slate-400 hover:bg-red-900/30 hover:text-red-400 transition-all duration-200">
          <LogOut size={18} />
          Logout
        </button>
      </div>
